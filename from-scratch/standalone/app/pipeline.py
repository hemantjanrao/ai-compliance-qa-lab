"""Text/PDF → chunks → Chroma. Used by `make ingest`."""
from __future__ import annotations

import os
from pathlib import Path

from app.chunking import pages_to_chunks
from app.embeddings import get_embedding_model_name, get_embedding_provider
from app.ingest import CORPUS_DIR, IngestError, resolve_corpus_path
